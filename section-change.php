<?php
include("handlers/section-changehandler.php");
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 clear-padding-xs">
                        <h5 class="page-title"><i class="fa fa-sliders"></i>Section Change</h5>
                    ...
                    <div class="col-lg-12 clear-padding-xs">
                        <div class="col-sm-12">
                            <div class="dash-item first-dash-item">
                                <h6 class="item-title"><i class="fa fa-sliders"></i>Choose which course you want to change your section in</h6>
                                <div class="inner-item">
                                    <form class="dash-form" action="" method="POST">
                                        <div class="col-md-6">
                                            <label><i class="fa fa-code"></i>COURSE CODE</label>
                                            <select name="sectionChange-course">
                                                <option>-- Select --</option>
                                                <?php foreach ($_SESSION['my-courses'] as $key => $value) :
                                                    $optionKey = $_SESSION['courses'][$value - 1][0];
                                                    echo "<option value='$optionKey'>" . $_SESSION['courses'][$value - 1][1] . '</option>';
                                                endforeach;
                                                ?>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label><i class="fa fa-code"></i>COURSE SECTION</label>
                                            <select name="sectionChange-section">
                                                <option value="1">First Section Hours</option>
                                                <option value="2">Second Section Hours</option>
                                                <option value="3">Third Section Hours</option>
                                            </select>
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                        <label><i class="fa fa-info-circle"></i>WHY YOU WANT TO CHANGE YOUR COURSE SECTION</label>
                                        <textarea></textarea>
                                        <button class="btn" type="submit" name="submit"><i class="fa fa-plus"></i> Submit</button>
                                    </form>
                                    <br>
                                        ...
                                        <tbody>
                                            <?php foreach ($_SESSION['my-courses'] as $key => $value) : ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo "First Section Hours -> " . $_SESSION['courses'][$value - 1][4][0] . " <br>Second Section Hours -> " . $_SESSION['courses'][$value - 1][4][1] . " <br>Third Section Hours -> " . $_SESSION['courses'][$value - 1][4][2]; ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
